...
export function SalesTrendChart({ trendData }: SalesTrendChartProps) {
  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-3xl p-6 shadow-xl space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 text-xs font-semibold">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-gray-300">Omset</span>
          </div>
          <div className="flex items-center gap-1.5">
      ...
      <div className="h-64 flex items-end justify-between gap-2 pt-6 border-b border-gray-850 px-2">
        {trendData.map((day, idx) => {
          ...
          return (
            <div key={idx} className="flex-1 flex flex-col items-center group relative h-full justify-end">
              ...
              {/* X-Axis Label */}
              <p className="text-[10px] text-gray-500 font-semibold mt-3 select-none text-center">
                {day.label}
              </p>
            </div>
          );
