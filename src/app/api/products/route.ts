...
export const GET = withErrorHandler('products.GET', async (): Promise<NextResponse> => {
...
export const POST = withErrorHandler('products.POST', async (request: Request): Promise<NextResponse> => {
